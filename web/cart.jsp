...
<html lang="en">
    ...
    <body>
        ...
        <sql:query var="listUsers"   dataSource="${myDS}">
            SELECT * FROM cart where bought='false' ;
        </sql:query>
                                    ...
                                    <table cellspacing="0" class="shop_table cart">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="cart_item">
                                                ...
                                                <c:forEach var="product" items="${listUsers.rows}">

                                                    <td class="product-remove">
                                                        <a title="Remove this item" class="remove" href="DeleteProductCart?id=${product.productId}">×</a> 
                                                    </td>
                                                    <sql:query var="listProducts"   dataSource="${myDS}">
                                                        SELECT * FROM product  where productId= ${product.productId};
                                                    </sql:query>
                                                    <c:forEach var="object" items="${listProducts.rows}">
                                                        <td class="product-thumbnail">
                                                            <img src="GetImage?x=${product.productId}" width="40px"/>
                                                        </td>

                                                        <td class="product-name">
                                                            <c:out value="${object.name}" />
                                                        </td>
                                                        <td><c:out value="${object.desc}" /></td>

                                                        <td class="product-price">
                                                            <span class="amount"><c:out value="${object.price}" /></span> 
                                                        </td>

                                                        <td><c:out value="${object.quantity}" /></td>
                                                        <td class="product-quantity">
                                                            <div class="quantity buttons_added">
                                                                <input type="number" size="4" class="input-text qty text" title="Qty" value="1" min="1" step="1" max="${object.quantity}">
