 ...
 */
console.log("inside all_products.js");
	...
	if(prod_all_request != null && prod_all_request.readyState == 4 && prod_all_request.status == 200)
	{
		...
		if(prod_all != null && prod_all_area != null)
		{
			...
			for(var i = 0; i < prod_all.length; i++)
			{
				...
				//prod_single_upper_img.src = "prod-img-serv?id=" + product.productId;
				...
				prod_name_link.href = "single-product.jsp?id=" + product.productId;
