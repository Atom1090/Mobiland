                    ...
                    <div class="product-content-right">
                        <div class="woocommerce">
                            ...
                            <form id="login-form-wrap" class="login collapse" method="post">
                                ...
                                <p>If you have shopped with us before, please enter your details in the boxes below. If you are a new customer please proceed to the Sign up section.</p>
                                        ...
                                        <div class="col-1">
                                            <div class="woocommerce-billing-fields">
                                                ...
                                                <p id="billing_city_field" class="form-row form-row-wide address-field validate-required" data-o_class="form-row form-row-wide address-field validate-required">
                                                    ...
                                                    <input type="date" value="" placeholder="Town / City" id="billing_city" name="billing_date" class="input-text " required="">
                                                </p>

                                                <p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
                                                    <label class="" for="billing_state">Interests</label>
                                                    <input type="text" id="billing_state" name="billing_state" placeholder="State / County" value="" class="input-text " required="">
                                                </p>
                                                ...
                                                <p id="billing_email_field" class="form-row form-row-first validate-required validate-email">
                                                    ...
                                                    <input type="email" value="" placeholder="" id="billing_email" name="billing_email" class="input-text " required="" onblur="checkEmail()">
                                                ...
                                                <p id="billing_phone_field" class="form-row form-row-last validate-required validate-phone">
                                                    ...
                                                    <input type="text" value="" placeholder="" id="billing_phone" name="billing_phone" class="input-text" onblur="checkPhone()">
